...
unsigned int __stdcall ThreadExecutor::threadProc(void *args)
{
    ...
    ZKCheck fileChecker(*threadExecutor, false);
    ...
    for (;;) {
        ...
        if (!threadExecutor->_settings.quiet) {
            ...
            ZKCheckExecutor::reportStatus(threadExecutor->_processedFiles, threadExecutor->_totalFiles, threadExecutor->_processedSize, threadExecutor->_totalFileSize);
